...
def sensor_data_handler(x, ctx, data):
...
try:
    print("0")
    callback_ctr = FnVoid_VoidP_DataP(sensor_data_handler)
    libmetawear.mbl_mw_acc_bmi160_set_step_counter_mode(d.board, AccBmi160StepCounterMode.NORMAL)
    libmetawear.mbl_mw_acc_bmi160_enable_step_counter(d.board)
    libmetawear.mbl_mw_acc_bmi160_write_step_counter_config(d.board)
    
    print("1")
    step_counter_signal = None #libmetawear.mbl_mw_acc_bmi160_get_step_counter_data_signal(d.board)
    print("2")
    libmetawear.mbl_mw_datasignal_subscribe(step_counter_signal, None, callback_ctr)
    print("3")
